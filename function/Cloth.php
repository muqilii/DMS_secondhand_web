...
<body>
  <header class="pb-3" style="background-image: url('img/cloth.jpg')"> 
  ...
  <body>
    ...
    <section class="result container-fluid">
      ...
      echo "<h6 class='ps-3 pt-3'> We found <strong>{$num_results}</strong> Results for category <strong>\"Cloth\"</strong> in {$query_time} seconds:</h6>";
      echo "</a>";
