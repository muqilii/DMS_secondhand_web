...
<body>
  <header class="pb-3" style="background-image: url('img/electronic.jpg')">
  ...
  <body>
    ...
    <section class="result container-fluid">
          ...
          <?php
            ...
            //$sql = "SELECT * FROM product WHERE c_id = '5'";
            $sql = "SELECT p.* 
            FROM product p
            ...
            echo "<h6 class='ps-3 pt-3'> We found <strong>{$num_results}</strong> Results for category <strong>\"Electronic\"</strong> in {$query_time} seconds:</h6>";
            echo "</a>";
