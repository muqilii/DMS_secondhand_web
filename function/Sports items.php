...
<body>
  <header class="pb-3" style="background-image: url('img/kun.jpg')">
 ...
 echo "<h6 class='ps-3 pt-3'> We found <strong>{$num_results}</strong> Results for category <strong>\"Sports item\"</strong> in {$query_time} seconds:</h6>";
 echo "</a>";
