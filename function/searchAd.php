...
<li class="nav-item">
    ...
    <div class="heading">
      ...
      <form class="search-bar d-flex flex-column flex-md-row px-5 align-items-stretch" method="get" action="searchAd.php">
        <input class="font-sm fw-bold" type="text" name="keyword2" placeholder="Find your product ~">
...
if (isset($_GET['keyword2'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<form id='loginform' action='delete_admin.php' method='post'>"; 
